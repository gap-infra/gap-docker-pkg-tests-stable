[![Build Status](https://travis-ci.org/gap-system/gap-docker-pkg-tests-stable.svg?branch=master)](https://travis-ci.org/gap-system/gap-docker-pkg-tests-stable)
...
tests are in https://github.com/gap-system/gap-docker-pkg-tests-stable-staging.
